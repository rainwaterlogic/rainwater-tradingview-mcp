...
**Email:** Open a private security advisory via [GitHub Security Advisories](https://github.com/rainwaterlogic/rainwater-tradingview-mcp/security/advisories/new).
